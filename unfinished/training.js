 ...
 */
function clearAll() {
  const meme = document.querySelector(".memes-content");
  const joke = document.querySelector(".jokes-content");
  const quote = document.querySelector(".quotes-content");
  const riddle = document.querySelector(".riddles-content");
...
function showMeme() {
  ...
  const memeContainer = document.querySelector(".memes-content");
  const newImage = document.createElement("img");
  newImage.setAttribute("scr", randomMemeUrl);
 ...
 */
function showJoke() {
  // Create a new "p" element inside a container with text content from "jokes" base
  const randomJokeText = getRandomData("jokes");

  const newJokeContainer = document.querySelector(".jokes-content");
 ...
 */
function showQuote() {
  // Create 2 new "p" elements inside a container with text content from "quotes" base
  // Value should be in format: { quote: '', author: '' }
  const randomQuote = getRandomData("quotes");
  const newQuoteContainer = document.querySelector(".quotes-content");
...
function showRiddle() {
  ...
  const newRiddleContainer = document.querySelector(".riddles-content");
  const newQuestion = document.createElement("p");
  const newAnswer = document.createElement("p");
  newQuestion.textContent = randomRiddle.question;
  newAnswer.textContent = randomRiddle.answer;
  newAnswer.setAttribute("id", "riddle-answer");
  newAnswer.hidden = true;
  newRiddleContainer.appendChild(newQuestion);
  newRiddleContainer.appendChild(newAnswer);
}
